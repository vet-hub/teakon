    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="tile col-start-1 row-start-5 bg-lime-600 card w-96  text-primary-content">
                    <div className="card-body">
                        <h2 className="card-title">Beschreibung:</h2>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                    </div>
                </div>
                <div className="tile col-start-6 col-span-2 row-start-5 bg-green-600 card w-96  text-primary-content">
                    <div className="card-body">
                        <h2 className="card-title">Nährstoffe:</h2>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                    </div>
                </div>
                <div className="tile col-start-10 col-span-1 row-start-5 bg-emerald-500 card w-96  text-primary-content">
                    <div className="card-body">
                        <h2 className="card-title">Zubereitung:</h2>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                    </div>
                </div>
                <div className="tile col-start-2 col-span-2 row-start-7 bg-teal-500 card w-96  text-primary-content">
                    <div className="card-body">
                        <h2 className="card-title">Nebenwirkungen:</h2>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                    </div>
                </div>
                <div className="tile col-start-9 col-span-2 row-start-7 bg-purple-500 card w-96  text-primary-content">
                    <div className="card-body">
