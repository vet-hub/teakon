...
<div className="criteriaSelection flex flex-col items-center w-full p-5">
    <h2 className="italic mb-2 lg:mb-10 font-bold md:m-5 max-[350px]:text-2xl  min-[351px]:text-3xl md:text-4xl text-black dark:text-gray-300" >Kriterien Auswahl</h2>
