    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center container mx-auto bg-gray-200 rounded-xl shadow border p-8 m-10">
                ...
                <img src={wrldmap} alt='wimage' className='w-full h-80 my-4' />

                <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-3 px-7 mt-4 border border-blue-500 hover:border-transparent rounded-full ">
                    zeige alle Tees
                </button>
            </div>
        </>
