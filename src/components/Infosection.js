            ...
            <div className="hero min-h-3/4">
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w">
                        ...
                        <button onClick={() => {setChosenCriterias([]);navigate("/ergebnisse/alle")}} className="bg-black hover:bg-white text-white font-bold hover:text-black py-2 px-4 lg:py-3 lg:px-7 mt-4 border border-black hover:border-transparent rounded-full opacity-60 duration-200">Zeige alle Tees</button>
                    </div>
                </div>
            </div>
        </>
