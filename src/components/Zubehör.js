    ...
    return (
        ...
        <div className="mt-6 mb-6">
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Teedose} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Aufgusskanne} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Bambusbesen} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Besenhalter} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Bambusloeffel} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Teewaage} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl mb-4">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Wasserkocher} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
            ...
            <div className="card card-side bg-base-100 shadow-xl">
                <figure className="w-1/2 sm:w-1/3"><img className="object-scale-down h-48 w-96" src={Stoevchen} alt="Movie" /></figure>
                <div className="card-body w-1/2 sm:-2/3 ">
